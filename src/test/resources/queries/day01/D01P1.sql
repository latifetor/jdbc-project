...
--Part1: Select-Distinct-Where-OrderBy-Like-GroupBy- Having
select * from EMPLOYEES;

--1. List all employees first and last name with their salary in employees table
...
--10. Count the total numbers of the departments in departs table = 27
